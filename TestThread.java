...
/*creation de la classe du thread de l'ecoute pour le client*/
public class  TestThread extends Thread {
    Socket obj;/*creation de la socket client */
    private BufferedReader fluxEntreeSocket;
public TestThread(String name,Socket obj){
...
/*la fonction run pour executerle thread et lire le message du serveur*/
public void run(){
    try {
        for(int i = 0; i < 10; i++)
       ...
       System.out.println(message);/* on affiche le message chifré */
        
        message = dechiffrement(3,message);
        System.out.println(message);/* on affiche le message en clair  */
